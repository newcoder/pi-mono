...
describe("idea-generator", () => {
	it("generates market-style ideas when momentum is strong", () => {
		const regime: MarketRegime = {
			...
			weakIndustries: [],
			factorIcSnapshot: {
				industry_momentum_20d_forward5d: { latest: 0.08, avg20d: 0.07, direction: "positive" },
				size_forward5d: { latest: -0.05, avg20d: -0.05, direction: "negative" },
				size_forward10d: { latest: -0.04, avg20d: -0.04, direction: "negative" },
				size_forward20d: { latest: -0.03, avg20d: -0.03, direction: "negative" },
			},
			sentimentIndex: 65,
			volatilityProxy: 2.5,
		};
	...
	it("generates classic ideas when regime is favorable", () => {
		const regime: MarketRegime = {
			...
			weakIndustries: [],
			factorIcSnapshot: {
				industry_momentum_20d_forward5d: { latest: 0.02, avg20d: 0.03, direction: "positive" },
				size_forward5d: { latest: -0.01, avg20d: -0.01, direction: "neutral" },
				size_forward10d: { latest: -0.01, avg20d: -0.01, direction: "neutral" },
				size_forward20d: { latest: -0.01, avg20d: -0.01, direction: "neutral" },
			},
			sentimentIndex: 70,
			volatilityProxy: 1.5,
		};
...
describe("feasibility-check", () => {
	it("fails when universe is too small", async () => {
		...
		const regime: MarketRegime = {
			...
			factorIcSnapshot: {
				industry_momentum_20d_forward5d: { latest: 0.08, avg20d: 0.07, direction: "positive" },
				size_forward5d: { latest: 0, avg20d: 0, direction: "neutral" },
				size_forward10d: { latest: 0, avg20d: 0, direction: "neutral" },
				size_forward20d: { latest: 0, avg20d: 0, direction: "neutral" },
			},
			sentimentIndex: 65,
			volatilityProxy: 2.5,
		};
