...
import * as _bundledPiAiCompat from "@mariozechner/pi-ai/compat";
import * as _bundledPiAiOauth from "@mariozechner/pi-ai/oauth";
import * as _bundledPiAiProviders from "@mariozechner/pi-ai/providers/all";
...
function getAliases(): Record<string, string> {
	...
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	const piAiCompatEntry = resolveWorkspaceOrImport("ai/dist/compat.js", "@mariozechner/pi-ai/compat");
